...
if (!isset($_SESSION['isLogin'])) {
    ...
    if ($_SESSION['role'] == "admin") {
        header("location:http://localhost/webtech_hotelbooking_project/pages/adminpage.php ");
    }
}
...
<head>
    ...
    <title>Aaideu - Hotel Management System</title>
            ...
            <div class="flex justify-between w-full items-center max-w-7xl ml-auto mr-auto px-6 py-2 lg:py-0">
                ...
                <div class="lg:block hidden">
                    <div class="flex gap-8 cursor-pointer ml-2 text-sm font-medium">
                        ...
                        <a href="Pages/room.php" class="hover:text-[#E5A819] transition-colors duration-150">Garden &
                            Terrace</a>
    ...
    <main class="">
        ...
        <section class="bg-[#F7F4ED] relative py-10">
            <div class="text-center py-4 flex flex-col gap-4">
                ...
                <h1 class="text-3xl md:text-5xl font-bold text-playfair">Why Guest Love Us</h1>
            ...
            <div class="max-w-7xl grid md:grid-cols-2 grid-cols-1 gap-16 mx-auto mt-4 p-6">
                ...
                <div>
                    ...
                    <div class="text-black/60 font-medium">
                        ...
                        <button
                            class="py-3 px-6 bg-[#193366] text-white/90 rounded-full hover:bg-[#314b7d] cursor-pointer mt-8 transition-colors duration-200">Explore
                            Our Rooms</button>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-[#1B2232]">
            <div class="px-6 py-12 max-w-7xl text-center mx-auto text-white">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold p-10 text-playfair">What Our Guest Say</h1>
        ...
        <div class="p-15 relative text-white text-center flex flex-col gap-8">
            ...
            <div class="flex gap-3 flex-wrap justify-center">
                <button class="py-2.5 px-8 bg-primary cursor-pointer text-xl font-medium text-white rounded-full">Book
                    Now</button>
                <button
                    class="py-2.5 px-8 border border-gray-200/70 cursor-pointer hover:bg-gray-50/30 text-xl font-medium text-white rounded-full">WhatsApp
                    Up</button>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-8 justify-between text-white">
                ...
                <span>
                    ...
                    <div
                        ...
                        <span><i class="fa-regular fa-envelope"></i>maharjanprasish5@gmail.com</span>
